...
<template>
    <ActionSection>
        <template #title> Double Authentication </template>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600">
                <p>
                    ...
                    serez invité à entrer un code sécurisé et aléatoire lors de
                    l'authentification. Vous pouvez récupérer ce code depuis
                ...
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p v-if="confirming" class="font-semibold">
                            ...
                            de l'application d'authentification de votre
                            téléphone ou saisissez la clé de configuration et
                            fournissez le code OTP généré.
                        </p>
                    ...
                    >
                        <p class="font-semibold">
                            Configuration clef: <span v-html="setupKey"></span>
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="font-semibold">
                            ...
                            si votre appareil d'authentification à deux facteurs
                            est perdu.
                        </p>
                    </div>
